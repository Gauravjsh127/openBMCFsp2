 ...
 * @return '0' on success, non-0 otherwise
 */
extern int ffs_entry_add(ffs_t *, const char *, off_t, uint32_t, ffs_type_t, uint32_t)
/*! @cond */ __nonnull ((1,2)) /*! @endcond */ ;
 ...
 */
extern ssize_t ffs_entry_read(ffs_t *, const char *, void *, off_t, uint32_t)
/*! @cond */ __nonnull ((1,2)) /*! @endcond */ ;
 ...
 */
extern ssize_t ffs_entry_write(ffs_t *, const char *, const void *, off_t, uint32_t)
/*! @cond */ __nonnull ((1,2)) /*! @endcond */ ;
