...
from omniidl_be.fips import util
...
class SupportedASTVisitor(idlvisitor.AstVisitor):
    ...
    def visitOperation(self, node):
        ...
        rt = node.returnType()
        if rt.kind() != idltype.tk_void and \
           (rt.kind() != idltype.tk_alias or rt.name() != "ErrlFlattened"):
            failstr = "ERROR: Return type must be ErrlFlattened or void. " + \
                      "FILE: " + node.file() + " LINE: " + str(node.line())
            util.fatalError(failstr)
