...
import omniidl_be.fips.skel.main
import omniidl_be.fips.skel.poa
...
def monolithic(stream, tree):
    ...
    skel = omniidl_be.fips.skel.main.__init__(stream)
    tree.accept(skel)

    poa_skel = omniidl_be.fips.skel.poa.__init__(stream)
