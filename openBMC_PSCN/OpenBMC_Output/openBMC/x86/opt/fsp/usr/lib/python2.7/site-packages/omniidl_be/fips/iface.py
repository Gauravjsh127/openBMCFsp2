...
from omniidl_be.fips import types, id, call, ast, cxx, output, config, descriptor
# from omniidl_be.fips import header
# from omniidl_be.fips import skel
...
import omniidl_be.fips.skel
import omniidl_be.fips.header
...
class I_Helper(Class):
  ...
  def hh(self, stream):
    ...
    if self.interface().abstract():
      helper_tpl = omniidl_be.fips.header.template.abstract_interface_Helper
    elif self.interface().local():
      helper_tpl = omniidl_be.fips.header.template.local_interface_Helper
    else:
      helper_tpl = omniidl_be.fips.header.template.interface_Helper
  ...
  def cc(self, stream):
    stream.out(omniidl_be.fips.skel.template.interface_Helper,
...
class I(Class):
  ...
  def hh(self, stream):
    if self.interface().abstract():
      ...
      stream.out(omniidl_be.fips.header.template.abstract_interface_type,
                 name=self.interface().name().simple(),
      ...
      if abstract_base:
        abstract_narrows = omniidl_be.fips.header.template.\
      ...
      stream.out(omniidl_be.fips.header.template.local_interface_type,
                 name=self.interface().name().simple(),
      ...
      stream.out(omniidl_be.fips.header.template.interface_type,
                 name=self.interface().name().simple(),
                 abstract_narrows = abstract_narrows,
                 Other_IDL = self._other_idl)
...
class _objref_I(Class):
  ...
  def hh(self, stream):
    ...
    if config.state['Shortcut']:
      ...
      shortcut.out(omniidl_be.fips.header.template.interface_shortcut,
                   name = self.interface().name().simple())
    ...
    stream.out(omniidl_be.fips.header.template.interface_objref,
               name = self.interface().name().simple(),
  ...
  def cc(self, stream):
    ...
    def _ptrToObjRef_ptr(self = self, stream = stream):
      ...
      for i in self.interface().allInherits():
        ...
        stream.out(omniidl_be.fips.skel.template.interface_objref_repoID_ptr,
    ...
    def _ptrToObjRef_str(self = self, stream = stream):
      ...
      for i in self.interface().allInherits():
        ...
        stream.out(omniidl_be.fips.skel.template.interface_objref_repoID_str,
                   inherits_fqname = i.name().fullyQualify())
    ...
    if config.state['Shortcut'] == 2:
      release_shortcut = omniidl_be.fips.skel.template.\
                         interface_release_refcount_shortcut
    else:
      release_shortcut = ""

    stream.out(omniidl_be.fips.skel.template.interface_objref,
               name = self.interface().name().fullyQualify(),
    ...
    if shortcut_mode:
      ...
      for i in self.interface().inherits():
        ...
        inherited.out(omniidl_be.fips.skel.template.interface_shortcut_inh,
                      parent=objref_str)

      if shortcut_mode == 1:
        tmpl = omniidl_be.fips.skel.template.interface_shortcut
      else:
        tmpl = omniidl_be.fips.skel.template.interface_shortcut_refcount
    ...
    for method in self.methods():
      ...
      if config.state['Shortcut']:
        ...
        if config.state['Shortcut'] == 2:
          tmpl = omniidl_be.fips.skel.template.\
...
class _nil_I(Class):
  ...
  def cc(self, stream):
    ...
    stream.out(omniidl_be.fips.skel.template.local_interface_objref,
               name = self.interface().name().fullyQualify(),
    ...
    for method in self.methods():
      ...
      body.out(omniidl_be.fips.skel.template.local_interface_nil_operation)

      if not method.return_type().void():
        body.out(omniidl_be.fips.skel.template.local_interface_nil_dummy_return,
                 method = method.name(),
...
class _pof_I(Class):
  ...
  def hh(self, stream):
    stream.out(omniidl_be.fips.header.template.interface_pof,
               name = self.interface().name().simple())
  ...
  def cc(self, stream):
    ...
    for i in self.interface().allInherits():
      ...
      inherits.out(omniidl_be.fips.skel.template.interface_pof_repoID, inherited = ancestor)

    node_name = self.interface().name()
    objref_name = node_name.prefix("_objref_")
    pof_name = node_name.prefix("_pof_")
    stream.out(omniidl_be.fips.skel.template.interface_pof,
...
class _impl_I(Class):
  ...
  def hh(self, stream):
    ...
    if self.interface().abstract():
      abstract = omniidl_be.fips.header.template.interface_impl_abstract
    elif inherit_abstract:
      abstract = omniidl_be.fips.header.template.interface_impl_not_abstract
    else:
      abstract = ""
        
    stream.out(omniidl_be.fips.header.template.interface_impl,
               name = self.interface().name().simple(),
  ...
  def cc(self, stream):
    ...
    def dispatch(self = self, stream = stream):
      ...
      for i in self.interface().inherits():
        ...
        stream.out(omniidl_be.fips.skel.template.interface_impl_inherit_dispatch,
    ...
    def _ptrToInterface_ptr(self = self, stream = stream):
      for i in self.interface().allInherits():
        ...
        stream.out(omniidl_be.fips.skel.template.interface_impl_repoID_ptr,
    ...
    def _ptrToInterface_str(self = self, stream = stream):
      for i in self.interface().allInherits():
        ...
        stream.out(omniidl_be.fips.skel.template.interface_impl_repoID_str,
                   inherited_name = inherited_str,
                   impl_inherited_name = impl_inherited_str)
    ...
    stream.out(omniidl_be.fips.skel.template.interface_impl,
    ...
    if not self.interface().abstract():
      ...
      for i in self.interface().inherits():
        if i.abstract():
          ...
          break
      if inherit_abstract:
        stream.out(omniidl_be.fips.skel.template.interface_impl_not_abstract,
                   impl_fqname = impl_name.fullyQualify())
...
class _sk_I(Class):
  ...
  def hh(self, stream):
    ...
    stream.out(omniidl_be.fips.header.template.interface_sk,
               name = self.interface().name().simple(),
