...
# -----------------------------
# Configuration data
from omniidl_be.fips import config

# -----------------------------
# Utility functions
from omniidl_be.fips import ast, cxx, output, util

#import omniidl_be.fips.dynskel.tcstring
import omniidl_be.fips.dynskel.typecode
import omniidl_be.fips.dynskel.main
import omniidl_be.fips.dynskel.template
...
def generate(stream, tree):
    ...
    tcstring = omniidl_be.fips.dynskel.tcstring.__init__(stream)

    Typecode = omniidl_be.fips.dynskel.typecode.__init__(stream)
    tree.accept(Typecode)

    Main = omniidl_be.fips.dynskel.main.__init__(stream)
    tree.accept(Main)
