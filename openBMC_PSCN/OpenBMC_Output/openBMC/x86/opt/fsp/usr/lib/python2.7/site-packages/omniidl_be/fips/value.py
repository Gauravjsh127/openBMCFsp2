...
from omniidl_be.fips import mapping, call, output, config, skutil
from omniidl_be.fips import id, types, iface, cxx, ast, util
...
class ValueType (mapping.Decl):
    ...
    def module_decls(self, stream, visitor):
        ...
        from omniidl_be.fips.header import defs
        ...
        if config.state['Typecode']:
            from omniidl_be.fips.header import defs, template
